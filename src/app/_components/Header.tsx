...
export const Header = () => {
  return (
    <div className="h-[109px] px-10 py-6 flex justify-between">
      <div className="w-[100px] h-[61px] text-[#DC4A2D] font-bold bg-[#E7E7E7] flex items-center justify-center">
        Logo
      </div>
      <div className="flex justify-between gap-x-[64px] border-[0.5px] rounded-full h-[74px]  p-2">
        <div className=" h-[58px] flex gap-x-2 bg-[#DC4A2D] rounded-full p-4">
          {BRIEFCASE} Jobs{" "}
        </div>
        <div className=" h-[58px] text-[#B0B0B0] flex gap-x-2 rounded-full p-4">
          {MESSAGE} Messages{" "}
        </div>
        <div className=" h-[58px] text-[#B0B0B0] flex gap-x-2  rounded-full p-4">
          {HAND} Payment{" "}
