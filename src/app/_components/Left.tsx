...
export const Left = () => {
  return (
    <div className="py-9 px-[25px]">
      <div className="flex gap-x-4">
        <div
          style={{ border: "0.8px solid #DC4A2D" }}
          className="py-[12px] flex w-[172px] items-center justify-center gap-x-[10px] rounded-lg bg-[#FEF4F2]"
        >
          <div className="">{TRASH}</div>
          <div className="text-[#DC4A2D] text-[16px]">Delete job</div>
        </div>
        <div
          style={{ border: "0.8px solid #DC4A2D" }}
          className="py-[12px] flex w-[172px] items-center justify-center gap-x-[10px] rounded-lg bg-[#DC4A2D]"
        >
          <div className="">{EDIT}</div>
          <div className=" text-white text-[16px]">Edit job</div>
        </div>
      </div>
      <div className="p-3 mt-6">
        <div className="flex justify-between">
          <div className="flex gap-x-[10px]">
            {USERS} <div>Applicants</div>
          </div>
          <div className="font-semibold text-[20px]">400</div>
        </div>
        <div className="border-b-[1px] border-[#E7E7E7] my-4" />
        <div className="flex justify-between">
          <div className="flex gap-x-[10px]">
            {MATCH} <div>Matches</div>
          </div>
          <div className="font-semibold text-[20px]">100</div>
        </div>
        <div className="border-b-[1px] border-[#E7E7E7] my-4" />
        <div className="flex justify-between">
          <div className="flex gap-x-[10px]">
          ...
          <div className="font-semibold text-[20px]">147</div>
        </div>
        <div className="border-b-[1px] border-[#E7E7E7] my-4" />
        <div className="flex justify-between">
          <div className="flex gap-x-[10px]">
          ...
          <div className="font-semibold text-[20px]">800</div>
        </div>
      </div>
    </div>
  );
